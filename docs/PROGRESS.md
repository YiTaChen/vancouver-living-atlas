...
- TypeScript and 23 geography, localization, ray-picking, pointer-gesture and navigation tests pass. Tests exercise the actual placement/navigation methods with Three.js camera math and in-memory event surfaces; no browser interaction or screenshot review was performed for this update.
